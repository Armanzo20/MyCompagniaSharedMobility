...
public class Moped extends MotorVehicle {
    ...
    public Moped(String licensePlate, DrivingLicence requiredLicense, PowerSource powerSource, double drivingRangeInKm, Position geographicPosition, BigDecimal pricePerMinute, boolean isHelmetNecessary) {
