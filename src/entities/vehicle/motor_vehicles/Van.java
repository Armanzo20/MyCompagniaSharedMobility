...
public class Van extends MotorVehicle {
    ...
    public Van(String licensePlate, DrivingLicence requiredLicense, PowerSource powerSource, double drivingRangeInKm, Position geographicPosition, BigDecimal pricePerMinute, boolean isHelmetNecessary) {
